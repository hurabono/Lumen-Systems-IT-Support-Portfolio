...
| [LUM-005](./tickets/employee-lifecycle/LUM005-account-onboarding.md) | New hire starts Monday and needs access ready before 9 AM | Active Directory / Onboarding | Account creation in the correct OU, department security group instead of per-user ACLs, home folder and share access, first sign-in tested on a domain-joined client before handover |
## Knowledge Base
